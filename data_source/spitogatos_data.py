...
class SpitogatosData:
    ...
    def get_by_polygon(self, location: Rectangle, min_area: int = None, max_area: int = None) -> List[Asset]:
        ...
        headers = {
            ...
            "x-locale": "en",
            "x-mdraw": "1",
            "referer": f"https://www.spitogatos.gr/en/for_sale-homes/map-search/minliving_area-{min_area}/maxliving_area-{max_area}/plg-I3KUOzeYZVwQVrEpyia6RHypNboSnKJrJR",
        ...
        data = {
            ...
            "livingAreaLow": str(min_area),
            "livingAreaHigh": str(max_area),
            "sortBy": "rankingscore",
            "sortOrder": "desc",
            "offset": 0,
