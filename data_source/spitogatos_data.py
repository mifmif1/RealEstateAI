...
class SpitogatosData:
        ...
        params = {
            {
                ...
                "sortOrder": "desc",
                "offset": 0,
                "geoPolygons": [[[23.736840738696007, 37.98385854262262],
                                 [23.736817460507872, 37.987824136801486],
                                 [23.730424935327076, 37.987807214304055],
                                 [23.730403483900318, 37.983813395752165]]]
            }
        }
    ...
    def get_by_location(self, location: Rectangle, min_area: int = None,
        ...
        self._headers["accept-encoding"] = "gzip, deflate, br, zstd"
